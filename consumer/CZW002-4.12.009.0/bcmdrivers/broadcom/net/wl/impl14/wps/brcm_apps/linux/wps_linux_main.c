 ...
 *
 * $Id: wps_linux_main.c 372004 2012-11-30 03:46:58Z $
 */
#include <stdio.h>
...
#ifdef DSLCPE
		force_oob=nvram_get("force_oob");
		if (!oob || force_oob!=NULL)
#else
		if (!oob)
#endif
			oob = "enabled";
...
wps_osl_build_conf()
{
	...
	print_conf(NULL, NULL, "wps_enr_block_settings", NULL);	
#endif
...
#ifdef DSLCPE_NG
	print_conf(NULL, NULL, "wps_aplockdown_disable", NULL);
#endif
...
#ifdef DSLCPE_NG
	print_conf(NULL, NULL, "wps_randomssid_5G", NULL);
	print_conf(NULL, NULL, "wps_randomkey_5G", NULL);
#endif
