...
#define VC_HUNT_SERV_OPT_STATICIP      0x0008
#if 1 // __CLTK__, SeanLu 20150123, Support Send PADT
#define VC_HUNT_SERV_OPT_PPPOE_PADT     0x0010
#endif
...
#if 1 //__MSTC__, JhihPing, /* auto hunt */
typedef struct XtmAutoHuntVidInfo
{
   signed long lHuntedVid; 		
   UINT32 ulHuntedVidService;
} XTM_AUTOHUNT_VID_INFO, *PXTM_AUTOHUNT_VID_INFO;
#if 1 // __CLTK__, SeanLu 20150123, Support Send PADT
typedef struct XtmAutoHuntSessionInfo
{
   UINT8 MACAddress[6];
   UINT8 SessionID[2];
   UINT8 HostID[4];
} XTM_AUTOHUNT_SESSION_INFO, *PXTM_AUTOHUNT_SESSION_INFO;
#endif
typedef struct XtmVcHuntTestCfg
{
   ...
   signed long lVlanId;
   XTM_AUTOHUNT_VID_INFO huntedVidInfo[HUNT_MAX_VID];
   UINT8 ucHuntedVidCount;
   UINT32  ulPingSrcIp;
   UINT32  ulPingGatewayIp;
#if 1 // __CLTK__, SeanLu 20150123, Support Send PADT
   XTM_AUTOHUNT_SESSION_INFO ulSessionInfo;
#endif
