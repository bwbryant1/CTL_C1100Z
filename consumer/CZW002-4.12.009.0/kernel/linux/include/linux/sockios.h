...
#ifdef CONFIG_BUILD_HPNA //__MTSC__, Delon Yu, Support HPNA, merge from 4.02L03 KJ
#define SIOCSENABLEPORT 0x894B  /* enable ethernet port, KuanJung*/ 
#define SIOCSDISABLEPORT 0x894C /* disable ethernet port, KuanJung*/ 
#endif
