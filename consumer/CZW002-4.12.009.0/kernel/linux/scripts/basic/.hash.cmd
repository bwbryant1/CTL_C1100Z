cmd_scripts/basic/hash := gcc -Wp,-MD,scripts/basic/.hash.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -Werror -Wfatal-errors     -o scripts/basic/hash scripts/basic/hash.c  
