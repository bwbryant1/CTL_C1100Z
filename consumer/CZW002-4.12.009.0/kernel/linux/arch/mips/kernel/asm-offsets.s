 ...
 # -mno-abicalls -msoft-float -march=mips32 -mtune=mips32 -mllsc
 # -mno-shared -auxbase-strip arch/mips/kernel/asm-offsets.s -O2 -Wall
...
->PT_CAUSE 168 offsetof(struct pt_regs, cp0_cause)	 #
 # 0 "" 2
 # 71 "arch/mips/kernel/asm-offsets.c" 1
...
->TASK_STRUCT_SIZE 1128 sizeof(struct task_struct)	 #
 # 0 "" 2
...
->IC_SOFTIRQ_PENDING 0 offsetof(irq_cpustat_t, __softirq_pending)	 #
 # 0 "" 2
 # 299 "arch/mips/kernel/asm-offsets.c" 1
	
->IC_IRQ_CPUSTAT_T 16 sizeof(irq_cpustat_t)	 #
 # 0 "" 2
