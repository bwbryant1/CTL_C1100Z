...
#ifdef _CFE_    //__MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
...
static void nand_mark_bad_blk(PCFE_NAND_CHIP pchip, unsigned long page_addr)
{
#if 0 // __MSTC__, merge from 412L06, undefined reference of blparms_set_str, keep original version
...
static int nandflash_check_ecc(void)
{
    ...
    if( (intrCtrl & 0x00000080) != 0 )
    {
#if 0 //__MSTC__, Richard.
#if 1//__MTS__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
    ...
    if( len <= pchip->chip_block_size )
    {
        ...
        do
        {
                 ...
                 ret == FLASH_API_OK; i += CTRLR_CACHE_SIZE)
            {
                ...
                NAND_INTR->NandInterrupt = 0x00000fff;
