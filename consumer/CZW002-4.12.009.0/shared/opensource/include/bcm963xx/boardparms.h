...
#define MAC_IF_RGMII_3P3V       (4 << MAC_IFACE_S)
...
#define RGMII_DIRECT_3P3V        (PHY_LNK_CFG_VALID | FORCE_LINK_1000FD | MAC_CONN_VALID | MAC_MAC_IF | MAC_IFACE_VALID | MAC_IF_RGMII_3P3V)
#define GMII_DIRECT              (PHY_LNK_CFG_VALID | FORCE_LINK_1000FD | MAC_CONN_VALID | MAC_MAC_IF | MAC_IFACE_VALID | MAC_IF_GMII)
#ifdef BUILD_HPNA 
#define MII_DIRECT_HPNA          (PHY_LNK_CFG_VALID | FORCE_LINK_100FD | MAC_CONN_VALID | MAC_PHY_IF | MAC_IFACE_VALID | MAC_IF_MII)
#endif
#if 1 /*__MSTC__, Delon*/
#define TMII_DIRECT               (PHY_LNK_CFG_VALID | FORCE_LINK_100FD | MAC_CONN_VALID | MAC_PHY_IF | MAC_IFACE_VALID | MAC_IF_MII)
#endif/*__MSTC__, Delon*/
...
#define IsRGMII_2P5V(id)    ((id & MAC_IFACE_VALID)?((id & MAC_IFACE) == MAC_IF_RGMII):0)
#define IsRGMII_3P3V(id)    ((id & MAC_IFACE_VALID)?((id & MAC_IFACE) == MAC_IF_RGMII_3P3V):0)
