...
#if 1 //def BUILD_HPNA //__MTSC__, Delon Yu, Support HPNA
#define HPNA_SWVERSION_LEN 0
#endif

#if 1 //def BUILD_HPNA
#define RESERVED_LEN    (TAG_LEN - TAG_VER_LEN - SIG_LEN - SIG_LEN_2 - CHIP_ID_LEN - BOARD_ID_LEN - \
                        (4*IMAGE_LEN) - (3*ADDRESS_LEN) - (3*FLAG_LEN) - (2*VERSION_LEN) - (2*TOKEN_LEN) - HPNA_SWVERSION_LEN)
#else
#define RESERVED_LEN    (TAG_LEN - TAG_VER_LEN - SIG_LEN - SIG_LEN_2 - CHIP_ID_LEN - BOARD_ID_LEN - \
...
#endif
#if 0 //def BUILD_HPNA //__MTSC__, Delon Yu, Support HPNA
    char hpnaswversion[HPNA_SWVERSION_LEN];  // HPNA swversion
#endif
