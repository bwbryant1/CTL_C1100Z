...
#if 1 //__MTS__, RaynorChung: Support VDSL LED
  bp_usGpioLedVdsl,
...
#if 1 //__MTS__, RaynorChung: Support USB LED
  bp_usGpioLedUSB0,
...
static bp_elem_t g_bcm963168mbv_17a[] = {
  ...
  {bp_usGpioWPSRED,            .u.us = BP_SERIAL_GPIO_0_AH},
...
#elif defined(SUPPORT_MSTC_C1100)
static bp_elem_t g_bcm963168mbv_17a[] = {
  {bp_cpBoardId,               .u.cp = "963168MBV_17A"},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_ENABLE_GMAC },
  {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       ...
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioLedAdsl,           .u.us = BP_GPIO_15_AL},
  {bp_usGpioLedSesWireless,    .u.us = BP_GPIO_0_AH},
  {bp_usGpioLedWanData,        .u.us = BP_GPIO_8_AL},
  {bp_usGpioLedWanError,       .u.us = BP_GPIO_1_AH},
  {bp_usGpioLedBlPowerOn,      .u.us = BP_GPIO_20_AL},
  {bp_usGpioLedBlStop,         .u.us = BP_GPIO_21_AL},
  {bp_usGpioWLANRED,           .u.us = BP_GPIO_9_AL},
  {bp_usGpioLedUSB0,           .u.us = BP_GPIO_13_AH},
  {bp_usGpioWLANORANGE,        .u.us = BP_GPIO_23_AL},
  {bp_usGpioWPSRED,            .u.us = BP_GPIO_16_AH},
  {bp_usGpioADSLRED,           .u.us = BP_GPIO_14_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0}, 
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},  
  {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
  ...
  {bp_ulPhyId3,                .u.ul = BP_PHY_ID_3 | CONNECTED_TO_EXTERN_SW},
  {bp_ulPhyId4,                .u.ul = BP_PHY_ID_4 | CONNECTED_TO_EXTERN_SW},
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_INT | BP_AFE_LD_6302 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6302_REV_7_2_30}, // 0x10608700
...
static bp_elem_t g_bcm963168mbv_p501[] = {
  {bp_cpBoardId,               .u.cp = "963168MBV_P501"},
#if 1 // __MSTC__, Richard Huang, for 30a board
...
static bp_elem_t * g_BoardParms[] = {g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963168vx_p300, g_bcm963268bu, g_bcm963268bu_p300, g_bcm963168mbv_17a, g_bcm963168mbv_30a, g_bcm963168xh, g_bcm963168xh5, g_bcm963168mp, g_bcm963268v30a, g_bcm963168media, g_bcm963268sv2, g_bcm963168xfg3, g_bcm963168xf, g_bcm963168xm, g_bcm963168mbv3, g_bcm963168mbv17a302, g_bcm963168mbv30a302,g_bcm963168mbv_p501, 0};
...
#if 1 //__MTS__, RaynorChung: Ssupport VDSL LED
/**************************************************************************
...
#if 1 // __MSTC__, KuanJung
int BpGetGWANLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioGWAN, pusValue ) );
} /* BpGetGWANLedGpio */
#endif
int BpGetPppLedGpio( unsigned short *pusValue )
{
    int nRet;
    *pusValue = BP_SERIAL_GPIO_13_AL;
    nRet = BP_SUCCESS;
...
#if 1 //__MTS__, RaynorChung: Ssupport USB LED
/**************************************************************************
...
{
    return( BpGetUs(bp_usGpioWLANRED, pusValue ) );
} /* BpGetVdslLedGpio */

int BpGetWLANORANGELedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioWLANORANGE, pusValue ) );
} /* BpGetVdslLedGpio */

int BpGetWPSREDLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioWPSRED, pusValue ) );
} /* BpGetVdslLedGpio */

int BpGetADSLREDLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioADSLRED, pusValue ) );
} /* BpGetVdslLedGpio */
int BpGetADSL2REDLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioADSL2RED, pusValue ) );
} /* BpGetVdslLedGpio */
...
#ifdef BUILD_5G
/**************************************************************************
* Name       : BpGet5GResetGpio
*
* Description: This function returns the GPIO pin assignment for the Quantenna 5G
*              Reset signal.
*
* Parameters : [OUT] pusValue - Address of short word that the Quantenna 5G Reset
*                  signal GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
int BpGet5GResetGpio( unsigned short *pusValue ) {
        return( BpGetUs(bp_usGpio5GReset, pusValue ) );
} /*BpGet5GResetGpio*/

/**************************************************************************
* Name       : BpGet5GDisableGpio
*
* Description: This function returns the GPIO pin assignment for the Quantenna 5G
*              Disable signal.
*
* Parameters : [OUT] pusValue - Address of short word that the Quantenna 5G
*                  Disable GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
...
int BpGet5GDisableGpio( unsigned short *pusValue ) {
	return( BpGetUs(bp_usGpio5GDisable, pusValue ) );
} /*BpGet5GDisableGpio*/
#endif
...
int BpIsGpioInUse(unsigned short gpio)
{
    ...
    while( checkLed < 2 )
    {
        ...
        {
            if( checkLed )
                rc = BpGetLedGpio(i, &gpio2);
            else
                rc = BpGetGpioGpio(i, &gpio2);
