...
#include "dns.h"
      ...
      //set the timeout to 2 secs, If the CPE can't get the DSN response in 2 secs, change to 2nd DNS server
...
int errorCodeFailover;
#endif
#if 1 //__MSTC__, Loujia 0819 Dnsproxy pref
int dnsserverPref; //0:no pref, use querytype   1:ipv4 first 2: ipv6 first
#endif
