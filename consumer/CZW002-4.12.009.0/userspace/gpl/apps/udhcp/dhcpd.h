...
struct iface_config_t {
	...
	u_int32_t start_reservation;	/* Start address of leases, DHCP reservation list */
	u_int32_t end_reservation;		/* End address of leases, DHCP reservation list */
	char auto_reservation;         /* Enable (Yes) /Disable (No) DHCP reservation .*/
#endif
};
