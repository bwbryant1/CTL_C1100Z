...
typedef enum 
{
   ...
   CMS_MSG_DHCP_OPTION_FILTER                   = 0x1000026E, /**< Sent from any to webipqd to inform of option values */
   CMS_MSG_WEBSITE_INFO                         = 0x1000026F, /**< Sent from any to webipqd to reload url inforamtion */
   CMS_MSG_WEBIPQ_UPDATE                        = 0x10000274, /**< Sent from any to webipqd to reload url inforamtion */
   CMS_MSG_UPDATE_FLASH                         = 0x10000275, /**< Sent from dhcpd to ssk to inform of flash updating */
#endif
#if 1 //__MSTC__, SinJia, Web redirect for each ssid
   CMS_MSG_WLAN_WEB_REDIRECT_CHANGED            = 0x1000027A, /**< Sent from any to webipqd to reload url information**/
#endif
...
#if 1 //__CTLK__, Eric, refer to Q1000Z
   CMS_MSG_LAN_OR_WAN_IP_UPDATE 			 = 0x10000279, /**< Sent from wireless to webipqd to reload url and ip tables */
   CMS_MSG_SSIDURL_UPDATE			   = 0x1000027B, /**< Sent from wireless to webipqd to reload url and ip tables */
   CMS_MSG_SSIDMAC_UPDATE			  = 0x1000027C, /**< Sent from wireless to webipqd to reload mac table */
#endif
...
#if 1 //__CTLK__, Eric, refer to Q1000Z
   CMS_MSG_IPOX_STATE_CHANGE		 = 0x10000278,
#endif
...
#ifdef SUPPORT_IPV6_6RD //__CTLK__,JhenYang,refer to Q1000Z
	CMS_MSG_DHCPC_6RD_STATE_CHANGED             = 0x10000282, /**< Sent from dhcp client when 6RD state changes, see also Dhcpc6rdStateChangedMsgBody */
	CMS_MSG_DHCPC_6RD_OPTION_ENABLED            = 0x10000283, /**< Sent from dhcp client when 6RD state changes, see also Dhcpc6rdStateChangedMsgBody */
#endif
#if 1//__CTLK__,JhenYang
   CMS_MSG_RESET_WAN_STATISTICS                 = 0x10000284, /** */
#endif
#if 1//__MSTC__, Steven
   CMS_MSG_ACS_CONFIG_CHANGED_WITH_ACSURL= 0x10000285,
   CMS_MSG_DOWNLOAD_DIAG_COMPLETE_EVENT     = 0x10000286, /**< Download dignostic completed */
   CMS_MSG_TR69_CACERT_CHANGE 				 = 0x10000288, /** add a TR69 trusted ca certificate */
	CMS_MSG_CAPTIVE_PORTAL 				 = 0x10000289, /** add a TR69 trusted ca certificate */
#endif
#if 1 //__CTL__, KuanJung
	CMS_MSG_MCPD_IGMP_CHANGE					 = 0x1000028A, /**< Sent to ssk to force it add a igmp stat object */
#endif
...
#ifdef RMT_QCSAPI_SUPPORT //yiwei, support qtn 5GHz
...
#if 1 //yiwei, support tr069 parameters for qtn 5GHz interface counter
	CMS_MSG_RMTQCS_TR069_CONFIG_CHANGED	= 0x1000035D,
#endif
#ifdef RMT_QCSAPI_SUPPORT // change 5G module's MAC
	CMS_MSG_RMTQCS_MAC_CHANGED 			= 0x1000035E,
#endif
#endif
#if defined(RMT_QCSAPI_SUPPORT) //__CTLK__, winnie, supportconsole page for 5g
   CMS_MSG_RMTQCS_CLIENT_LIST_UPDATE			 = 0x1000035F, /**< Sent from httpd to ssk to inform of 5g client updating */
   CMS_MSG_RMTQCS_CLIENT_COUNTER_UPDATE			 = 0x10000360, 
   CMS_MSG_RMTQCS_CLIENT_LIST_UPDATE_BOTH		 = 0x10000361, 
#endif
...
#ifdef BRCM_WLAN // __CenturyLink__, Hong-Yu
   CMS_MSG_WLMNGR_READY				= 0x10000303,  /* Wireless daemon ready */
#endif
#if 1 // __CenturyLink__, Hong-Yu
   CMS_MSG_SMART_LED_UPDATE			= 0x10000304,  /* Wireless daemon ready */
#endif
#if 1//__CTLK__, LingChun, for WLAN, Disable WLAN when the WAN is working on the bridge mode
   CMS_MSG_WLAN_WANMODE_UPDATE		 = 0x10000305,	/* Wireless daemon ready */
   CMS_MSG_WLAN_SCHEDULE_UPDATE		 = 0x10000306,	/* Wireless daemon ready */
#endif
...
#if 1 //__QWEST__, Steven
   CMS_MSG_DSL_LINKTYPE_DELAY                   = 0x1000080E, 
#endif
#if 1  //__CTLK__, LingChun, __Qwest__, SinJia
   CMS_MSG_WPS_UPDATE_MSG	 					= 0x10000820,
#endif
#if 1//__CTLK__, Steven
   ...
   CMS_MSG_CHANG_INFO_APP		= 0x10000812, /**< request smd to change an app port	and ip addr*/
   CMS_MSG_CHANG_APP	= 0x10000813,
#endif
...
/*KeyYang@MSTC: Merge from Telefonica_Common, 20120712*/
   ...
   CMS_MSG_VLANAUTOHUNT_RETRY	   = 0x10002035,
   CMS_MSG_VLANAUTOHUNT_DISABLE  = 0x10002036,
   CMS_MSG_VLANAUTOHUNT_STOP2    = 0x10002037,
#if 1 // __CTLK__, SeanLu 20150429, Support CPE restart vlanautohunt when auto mode selected	
   CMS_MSG_VLANAUTOHUNT_RESTART_L3		= 0x10002038,
#endif
#endif
#if 1 //__MSTC__, JhihPing, /* auto hunt */
   CMS_MSG_VLANAUTOHUNT_REINIT_ETH_AUTOHUNT = 0x10002039,
#endif
#if 1 // __CTLK__, Richard Huang, for NTP update
   CMS_MSG_DHCPC_NTP_CHANGED     = 0x10002040,
#endif

#if 1 // __CTLK__, SeanLu 20150630, Support Restart Autohunt with L2 interface changed
   CMS_MSG_VLANAUTOHUNT_REINIT_ALL_WAN_AUTOHUNT = 0x10002041,
#endif
#if 1 // __CTLK__, SeanLu 20150714, Fix CPE doesn't restart vlanautohunt after unplug DSL line. 
   CMS_MSG_VLANAUTOHUNT_FINISHED_STOP	        = 0x10002042,
#endif
...
#endif /* DMP_X_404A03_DECTENDPOINT_1 */
...
/** Data body for CMS_MSG_DHCPC_NTP_CHANGED message type.
 *
 */
typedef struct
{
   char ntpserver[BUFLEN_16];
} DhcpcNTPChangedMsgBody;
...
#endif
#if 1 //__CTLK__, Thief
   char vendorClassID[BUFLEN_256];
   char userClassID[BUFLEN_256];
   char clientID[BUFLEN_256];
   char incomingPort[BUFLEN_8];
#endif
...
#if 1 //yiwei, support qtn get interface counter
typedef struct {
	UINT32 byteRx;
	UINT32 packetRx; 
	UINT32 byteTx;
...
typedef struct {
	...
	Counter_Body msgData;
} GetInterfaceCounterMsgBody;
#endif

#if 1 // change quantenna module's wifi mac
typedef struct
{
   char macAddr[MAC_ADDR_LEN];    /**< mac address of the host */
} SetQuantennaWifiMacMsgBody;
#endif
...
#if 1 /*Support Dhcp Option 77,__COMMON__, Ailsa*/
   char class_id[BUFLEN_256];
#endif
   char vsi[BUFLEN_256];
#endif
...
#if 1 // __CenturyLink__, Hong-Yu
/** Data body for CMS_MSG_SMART_LED_UPDATE message type.
 *
 */
typedef struct
{
   UBOOL8 timeout; /**< result for nslookup */
   UBOOL8 isNormal; /**< normal or special response */
   char color[BUFLEN_32]; /**< color for nslookup */
   char wg_instance[BUFLEN_64]; /**< wg_instance for nslookup */
   char message[BUFLEN_128]; /**< message for nslookup */
} smartLedUpdateMsgBody;
#endif
