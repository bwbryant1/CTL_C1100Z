 ...
 * then gets confused and have to look up some manual.
 */
 #if 0 //__CTL__,Wister for setting http timeout 20 min
#define HTTPD_EXIT_ON_IDLE_TIMEOUT  600
#else
#define HTTPD_EXIT_ON_IDLE_TIMEOUT  1200
#endif
...
#define TR64C_HTTP_CONN_PORT     53
#else
...
#if 1 // __CTLK__, SeanLu 20150112, Add some risk port protection
#define SMD_PORT 44401
#define ACSD_PORT 5916
#endif
