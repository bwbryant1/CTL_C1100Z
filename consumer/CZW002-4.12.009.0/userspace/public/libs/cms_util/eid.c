...
//__MSTC__, Nick Tseng, GUI Debug Mode with FTP
   ...
   {EID_TFTPD,
    ...
    0,
    TFTPD_PORT,
#if defined(RMT_QCSAPI_SUPPORT) // __CTLK__, Richard Huang
    TRUE,             /* isFeatureCompiledIn */
#else
    FALSE,
#endif
...
/* MSTC_VOICE */
   ...
   {EID_DHCP6S,
    ...
    "/bin/dhcp6s",
    "",                 /* run args */
#if 1 //__MSTC__, Loujia 0919 support muti radvd and dhcp6s for subnet ipv6
	EIF_MESSAGING_CAPABLE|EIF_MULTIPLE_INSTANCES,
#else
	EIF_MESSAGING_CAPABLE,
#endif
...
#if defined(RMT_QCSAPI_SUPPORT) //yiwei, support qtn 5GHz
	{EID_RMT_QCSAPI_MNGR,
	 NDA_ACCESS_WLAN,
